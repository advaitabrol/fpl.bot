...
def main_create_prediction(gw_folder_name, seasons=['2024-25']):
    ...
    # Example usage
    merge_player_weeks(f'prediction_data/{CURRENT_SEASON}/{gw_folder_name}/def.csv', f'prediction_data/{CURRENT_SEASON}/{gw_folder_name}/final_def.csv')
    merge_player_weeks(f'prediction_data/{CURRENT_SEASON}/{gw_folder_name}/gk.csv', f'prediction_data/{CURRENT_SEASON}/{gw_folder_name}/final_gk.csv')
    merge_player_weeks(f'prediction_data/{CURRENT_SEASON}/{gw_folder_name}/mid.csv', f'prediction_data/{CURRENT_SEASON}/{gw_folder_name}/final_mid.csv')
    merge_player_weeks(f'prediction_data/{CURRENT_SEASON}/{gw_folder_name}/fwd.csv', f'prediction_data/{CURRENT_SEASON}/{gw_folder_name}/final_fwd.csv')
