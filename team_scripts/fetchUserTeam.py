...
def save_team_to_csv(team_data):
    """
    Saves the Fantasy Premier League team data to a CSV file. Each row represents a player with
    the following columns: full name, position, team name, is_captain (binary), and price.
    ...
    with open(file_name, mode="w", newline="", encoding="utf-8") as csv_file:
        fieldnames = ["full_name", "position", "team", "is_captain", "price"]
